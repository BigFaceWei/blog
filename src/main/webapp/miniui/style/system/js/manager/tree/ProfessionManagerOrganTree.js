Ext.ProfessionManagerOrganTree = Ext.extend(Ext.tree.TreePanel, {
	...
	initComponent: function() {
		Ext.ProfessionManagerOrganTree.superclass.initComponent.call(this, arguments);
	...
	loadOrgans: function(professionId, organgrade, organId){
		...
		Ext.apply(this.plugins[0], {
			doCheck: function(node, checked) {
		        ...
		        Ext.Ajax.request({
		     	   url: contextpath + '/tbp/sysmanager/manager.do?method=' + method + '&organGrade=' + organgrade + '&professionId=' + professionId,
