mini.TreePopupEdit = function () {
	this.data = [];
    mini.TreePopupEdit.superclass.constructor.call(this);
...
mini.extend(mini.TreePopupEdit, mini.PopupEdit, {
    name: "",
    formField: true,
    ...
    set: function (kv) {
        ...
        mini.TreePopupEdit.superclass.set.call(this, kv);
    ...
    _createPopup: function () {
        mini.TreePopupEdit.superclass._createPopup.call(this);
    ...
    _getButtonHtml: function () {
        ...
        return '<span class="mini-buttonedit-button" ' + hover + '><span class="mini-bindbuttonedit-icon"></span></span>';
    },
    setUrl: function (url) {
    	 this.getPopup();
    ...
    setOpenWindowWidth: function(openWindowWidth){
    	this.openWindowWidth = openWindowWidth;
    },
    getOpenWindowWidth: function(){
    	return this.openWindowWidth;
    },
    setOpenWindowHeight: function(openWindowHeight){
    	this.openWindowHeight = openWindowHeight;
    },
    getOpenWindowHeight: function(){
    	return this.openWindowHeight;
    },
    _create: function () {
    ...
    destroy: function (removeEl) {
        ...
        mini.TreePopupEdit.superclass.destroy.call(this, removeEl);
    },
    ...
    setEnabled: function (value) {
        mini.TreePopupEdit.superclass.setEnabled.call(this, value);
    ...
    idField : "",
    textField : "",
    setValueField: function (idField) {
    ...
    getAttrs: function (el) {
        var attrs = mini.TreePopupEdit.superclass.getAttrs.call(this, el);
        var jq = jQuery(el);

        mini._ParseString(el, attrs,
            ["valueField", "textField", "url", "value", "text", "textName","data","emptyText", "inputStyle", "defaultText", "openWindowWidth", "openWindowHeight",
...
mini.regClass(mini.TreePopupEdit, 'treepopupedit');